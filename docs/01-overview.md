...
*   `--context` flags: Ad-hoc file paths provided at runtime.
All identified files are uploaded via the Anthropic Beta Files API rather than being embedded directly into the prompt text.
